...
#include "bsp.h"   /* huart1:printf 输出目标串口 */

/* Variables */
extern int __io_getchar(void) __attribute__((weak));

/* Strong definition of __io_putchar: printf() goes through _write() ->
 * __io_putchar(). Without this, the weak symbol resolves to 0 and printf()
 * hard-faults. Redirect 到 USART1(huart1)使 printf 可用。 */
...
/* Heap grower: newlib's malloc() needs _sbrk. Grows from the linker-defined
 * "end" symbol (see _user_heap_stack in STM32F407XX_FLASH.ld). */
caddr_t _sbrk(int incr)
{
  extern char end asm("end"); /* Defined by the linker script */
